...
def getDatalogInfo(TER_keyword, file_paths:str, site_lbl:str, interval_columns:int):
    ...
    # Pad site_lbl_list to match the number of files
    while len(site_lbl_list) < len(TER_files):
        site_lbl_list.append('')
...
if __name__ == '__main__':
    ...
    # getDatalogInfo requires file_paths, site_lbl, and interval_columns
    print("CharDataCorrelation module loaded. Use getDatalogInfo() to run.")
